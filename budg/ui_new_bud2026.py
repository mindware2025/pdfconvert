...
from budg.bud2026_headers import HEADERS_BUD2026, BANNER_ANCHORS_BUD2026
...
def render_new_bud_tool():
    ...
    st.caption("Upload ONLY the **By_Customer** sheet. Optionally upload the **Insurance Master** to fill the Insurance column.")

    bud_upload = st.file_uploader("Upload **By_Customer** Excel", type=["xlsx", "xls"], key="new_uploader")
    ins_upload = st.file_uploader("Upload **Insurance Master** Excel (header at row 8)", type=["xlsx", "xls"], key="ins_uploader")
