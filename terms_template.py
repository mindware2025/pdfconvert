...
and the Final end-customer price for IBM SW licenses is not higher than {formatted_price} USD"""
        ),
...
e. Resale of the Products or Services by Reseller to the End User associated with the Special Bid by the date indicated in the Special Bid request."""),
        ...
        ("C55", """If reseller is a Distributor, Reseller may only market the Products and Services to the Resellers that Reseller has identified in the Special Bid request as bidding to the End User.
...
If Reseller is requesting a specific End User price or discount in the Special Bid, Reseller shall ensure, and shall require any Resellers to also ensure, that the intended End User receives the financial benefit of such price or discount.."""),
        ...
        ("C57", """IBM may audit directly or through VAD any Special Bid transactions in accordance with the terms of this Section 
