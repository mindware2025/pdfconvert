...
"""
        ...
        ("C40", """Transaction Agreement Reseller shall keep and maintain all records necessary to establish its compliance with the Agreement for at least three years after the Agreement end date."""),
        ("C41", """IBM and/or VAD or their auditors may periodically review Reseller's compliance with the Agreement, and may do so either remotely, on Reseller's premises during normal business hours, or a combination thereof. In connection with any such review, Reseller agrees to provide IBM and/or VAD, or their auditor, with relevant records and system tools output on request."""),
        ...
        ("C45", """Each party will comply with all laws and regulations applicable to its business and content, including, without limitation, those prohibiting corruption and bribery, such as the U.S. Foreign Corrupt Practices Act."""),
        ...
        ("C49", """Reseller agrees to comply with the IBM Code of Conduct available at:
https://www.ibm.com/investor/att/pdf/IBM_Business_Conduct_Guidelines.pdf

Reseller agrees to comply with the Midis Group Code of Conduct available at:
https://www.midisgroup.com/wp-content/uploads/2024/08/Code-of-Conduct-2023-English.pdf"""),
        ...
        ("C53", """The Special Bid discount or price for eligible Products or Services is subject to the following:
a. no other discounts, incentive offerings, rebates, or promotions apply, unless VAD specifies otherwise in writing;
b. availability of the Products or Services;
c. Reseller's acceptance of the additional terms contained in the Special Bid Addendum"""),
        ("C54", """d. Reseller's advising the local VAD financing entity/organization of any Special Bid pricing;
e. Resale of the Products or Services by Reseller to the End User associated with the Special Bid by the date indicated in the Special Bid request."""),
        ("C55", """If Reseller is requesting a specific End User price or discount in the Special Bid, Reseller shall ensure, and shall require any Resellers to also ensure, that the intended End User receives the financial benefit of such price or discount."""),
        ("C56", "IBM's Audit of Special Bid Transactions", {"bold": True}),
        ("C57", """IBM may audit directly or through VAD any Special Bid transactions in accordance with the terms of this Section. Upon VAD's request, Reseller will promptly provide VAD or its auditors with all relevant Documentation."""),
        ("C58", """In any case where reseller is unable to provide the Documentation because of confidentiality obligations owed to an End User, Reseller will promptly provide VAD with written evidence of such obligations."""),
        ("C59", """Reseller hereby waives any objection to i) VAD and/or IBM sharing Special Bid information directly with the End User, and ii) the End User sharing Special Bid information directly with IBM/VAD for compliance review purposes."""),
        ("C60", """These Terms and Conditions are binding and form an integral part of any agreement between Mindware FZ-LLC and the Partner.
Mindware may include additional terms in its quotations before its acceptance by the Partner, which the Partner agrees to be bound by as if fully incorporated into the agreement.
Notes:
It is understood that final coverage dates for New Licenses and Software Subscription and Support Reinstatement part numbers will be based upon IBM's acceptance of the Purchase Order, as defined by the Passport Advantage program, irrespective of the dates which may appear in this special bid.
Pricing is valid for this transaction only.
