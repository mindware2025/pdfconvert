...
def show_login():
    # Force light theme on login, disable Streamlit dark mode
    st.markdown("""
    <style>
    :root, html, body {
    ...
    .aurora-bg::before {
        ...
        height:140%;
        top:-20%; left:-20%;
        background: radial-gradient(circle at 30% 40%, rgba(138,180,248,.35), transparent 60%),
                    radial-gradient(circle at 70% 60%, rgba(120,200,255,.22), transparent 65%),
                    radial-gradient(circle at 50% 80%, rgba(100,150,255,.25), transparent 60%);
