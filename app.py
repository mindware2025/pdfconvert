...
def show_login():
    bg_b64 ="image copy.png"  # <-- your AI-face image
    ...
    /* Dark overlay to improve contrast (optional but recommended) */
    .mw-login-bg::after {{
        content: "";
        position: absolute;
        inset: 0;
    ...
    # Layout: give space left for the image, right for card
    left, right = st.columns([2.2, 1])  # left bigger, right smaller
    with right:
