...
# Then find this section around line 295-296 and ADD the welcome code HERE:
...
# 🎉 ADD THE WELCOME CODE RIGHT HERE (after the st.stop() statements)
# This is where users arrive after successful login
